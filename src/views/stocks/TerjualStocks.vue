          ...
          <ul class="pagination d-flex justify-content-end">
            <li class="page-item" :class="{ disabled: !pagination.prev_page_url }">
              <a
                ...
                href="#"
                @click.prevent="fetchStockTerjual(pagination.prev_page_url)"
                >Kembali</a
              >
            </li>
            <li
            ...
            <li class="page-item" :class="{ disabled: !pagination.next_page_url }">
              <a
                class="page-link shadow-none"
                href="#"
                @click.prevent="fetchStockTerjual(pagination.next_page_url)"
                >Lanjut</a
              >
            </li>
          </ul>
...
const fetchStockTerjual = async (url = 'stocks/terjual') => {
  try {
...
const fetchDataPage = (page) => {
  const url = `stocks/terjual?page=${page}`
  fetchStockTerjual(url)
}

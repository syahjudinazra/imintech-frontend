          ...
          <ul class="pagination d-flex justify-content-end">
            <li class="page-item" :class="{ disabled: !pagination.prev_page_url }">
              <a
                ...
                href="#"
                @click.prevent="fetchStocksDiservice(pagination.prev_page_url)"
                >Kembali</a
              >
            </li>
            <li
            ...
            <li class="page-item" :class="{ disabled: !pagination.next_page_url }">
              <a
                class="page-link shadow-none"
                href="#"
                @click.prevent="fetchStocksDiservice(pagination.next_page_url)"
                >Lanjut</a
              >
            </li>
          </ul>
...
const fetchStocksDiservice = async (url = 'stocks/diservice') => {
  try {
...
const fetchDataPage = (page) => {
  const url = `stocks/diservice?page=${page}`
  fetchStocksDiservice(url)
}
...
const searchDiservice = () => {
  fetchStocksDiservice()
}

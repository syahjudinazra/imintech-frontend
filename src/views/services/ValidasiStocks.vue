          ...
          <ul class="pagination d-flex justify-content-end">
            <li class="page-item" :class="{ disabled: !pagination.prev_page_url }">
              <a
                ...
                href="#"
                @click.prevent="fetchValidasiStocks(pagination.prev_page_url)"
                >Kembali</a
              >
            </li>
            <li
            ...
            <li class="page-item" :class="{ disabled: !pagination.next_page_url }">
              <a
                class="page-link shadow-none"
                href="#"
                @click.prevent="fetchValidasiStocks(pagination.next_page_url)"
                >Lanjut</a
              >
            </li>
          </ul>
...
const fetchValidasiStocks = async (url = 'validasiStock') => {
  try {
...
const fetchDataPage = (page) => {
  const url = `validasiStock?page=${page}`
  fetchValidasiStocks(url)
}

  ...
  <CContainer fluid>
    <div class="d-flex align-items-end justify-content-between">
      <caption class="fw-bold">
        List of Data Validasi Pelanggan
      </caption>
          ...
          <ul class="pagination d-flex justify-content-end">
            <li class="page-item" :class="{ disabled: !pagination.prev_page_url }">
              <a
                ...
                href="#"
                @click.prevent="fetchValidasiPelanggan(pagination.prev_page_url)"
                >Kembali</a
              >
            </li>
            <li
            ...
            <li class="page-item" :class="{ disabled: !pagination.next_page_url }">
              <a
                class="page-link shadow-none"
                href="#"
                @click.prevent="fetchValidasiPelanggan(pagination.next_page_url)"
                >Lanjut</a
              >
            </li>
          </ul>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body bg-light">
          ...
          <pre id="salinData" class="highlight mt-4 d-flex flex-column">
            ...
            <span> </span>
            <span class="text-wrap">*Perbaikan :* <br /> {{ salinServicesForm.perbaikan }}</span>
            <span> </span>
            <span class="text-wrap">*Teknisi :* <br /> {{ salinServicesForm.teknisi }}</span>
            <span> </span>
      ...
      <div class="modal-content">
        ...
        <form @submit.prevent="moveService" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="mb-3" v-if="moveServicesForm.servicesdevice" hidden>
              <label class="fw-bold" for="servicesdevice_id">Tipe Device</label>
              <select
                class="form-select shadow-none"
                name="servicesdevice_id"
...
const fetchValidasiPelanggan = async (url = 'validasiPelanggan') => {
  try {
...
const fetchDataPage = (page) => {
  const url = `validasiPelanggan?page=${page}`
  fetchValidasiPelanggan(url)
}
...
function updateService() {
  if (!id.value) {
    console.error('Service ID is not set.')
    return
  }
...
function moveService() {
  axios
    .put(`moveservices/${id.value}`, moveServicesForm.value)
    .then((response) => {

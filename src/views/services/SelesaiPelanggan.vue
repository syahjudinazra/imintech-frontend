  ...
  <CContainer fluid>
    <div class="d-flex align-items-end justify-content-between">
      <caption class="fw-bold">
        List of Data Selesai Pelanggan
      </caption>
      ...
      <table class="table caption-top">
        ...
        <tbody v-if="services.length > 0">
          <tr v-for="(service, index) in services" :key="service.id">
            <td>{{ index + 1 }}</td>
            <td>{{ formatDate(service.tanggalselesai) }}</td>
          ...
          <ul class="pagination d-flex justify-content-end">
            <li class="page-item" :class="{ disabled: !pagination.prev_page_url }">
              <a
                ...
                href="#"
                @click.prevent="fetchSelesaiPelanggan(pagination.prev_page_url)"
                >Kembali</a
              >
            </li>
            <li
            ...
            <li class="page-item" :class="{ disabled: !pagination.next_page_url }">
              <a
                class="page-link shadow-none"
                href="#"
                @click.prevent="fetchSelesaiPelanggan(pagination.next_page_url)"
                >Lanjut</a
              >
            </li>
          </ul>
...
const fetchSelesaiPelanggan = async (url = 'selesaiPelanggan') => {
  try {
...
const fetchDataPage = (page) => {
  const url = `selesaiPelanggan?page=${page}`
  fetchSelesaiPelanggan(url)
}

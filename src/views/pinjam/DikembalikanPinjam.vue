      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input
              v-model="viewPinjamData.tanggalkembali"
              type="date"
              class="form-control shadow-none bg-light"
              id="tanggalkembali"
              readonly
          ...
          <div class="mb-3">
            ...
            <input
              v-model="viewPinjamData.penerima"
              type="text"
              class="form-control shadow-none bg-light"
              id="penerima"
              readonly
          ...
          <div class="mb-3">
            ...
            <textarea
              v-model="viewPinjamData.kelengkapankembali"
              class="form-control shadow-none bg-light"
        ...
        <form @submit.prevent="updatePinjam" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label for="tanggalkembali" class="form-label fw-bold">Tanggal Kembali</label>
              <input
                v-model="editedPinjam.tanggalkembali"
                type="date"
                class="form-control shadow-none"
                id="tanggalkembali"
              />
            ...
            <div class="mb-3">
              <label for="kelengkapankembali" class="form-label fw-bold">Kelengkapan Kembali</label>
              <textarea
                v-model="editedPinjam.kelengkapankembali"
                class="form-control shadow-none"
                id="kelengkapankembali"
              ></textarea>
            </div>
...
const fetchPinjam = async (url = 'getkembali') => {
  try {

...
const headers = ref([
  ...
  { text: 'No Spareparts', value: 'subject_details.no_spareparts' },
  { text: 'Device', value: 'subject_details.spareparts_device' },
...
const loadActivityLogs = async () => {
  loading.value = true
  try {
    const response = await axios.get('spareparts-activity', {
      params: {

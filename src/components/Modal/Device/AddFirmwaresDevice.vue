    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addForm_label">Add Firmwares Device</h5>
          <button
            type="button"
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger text-white" @click="AddFirmwaresDevice">
            Submit
          </button>
        </div>
      </div>
...
async function AddFirmwaresDevice() {
  if (!firmwaresDevice.value.name) {
    showToast('Input firmwares device name', 'error')
    return
  }

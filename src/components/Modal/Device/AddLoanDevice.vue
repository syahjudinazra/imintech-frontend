    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addForm_label">Add Loan Device</h5>
          <button
            type="button"
...
async function AddLoanDevice() {
  if (!loanDevice.value.name) {
    showToast('Input loan device name', 'error')
    return
  }

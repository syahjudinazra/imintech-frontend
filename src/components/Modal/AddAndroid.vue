    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addForm_label">Add android</h5>
          <button
            type="button"
...
async function AddAndroid() {
  if (!android.value.name) {
    showToast('Input android name', 'error')
    return
  }

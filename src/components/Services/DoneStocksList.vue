...
import MoveDoneStocks from '../Services/Modal/Stocks/MoveDoneStocks.vue'
...
const canEdit = computed(() => checkPermission('Edit Done'))
const canMove = computed(() => checkPermission('Move Done'))

<template>
  ...
  <button type="button" class="btn btn-danger btn-sm text-white" @click="openModal">Add RAM</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addForm_label">Add RAM</h5>
          <button
            type="button"
...
async function AddRam() {
  if (!ram.value.name) {
    showToast('Input ram name', 'error')
    return
  }
